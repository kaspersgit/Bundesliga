...
if(!exists("foo", mode="function")) source("external_connected_scripts/DE_db_updating.R")
if(!exists("foo", mode="function")) source("external_connected_scripts/DE_exp_lineups_V2.R")
if(!exists("foo", mode="function")) source("external_connected_scripts/DE_db_connection.R")
if(!exists("foo", mode="function")) source("external_connected_scripts/give_bf_odds.R")
if(!exists("foo", mode="function")) source("external_connected_scripts/DE_db_save_prediction.R")
...
if (nrow(give_bf_odds('DE'))!=0){
  ...
  DE_insert_predictions(real_and_predicted)
}
