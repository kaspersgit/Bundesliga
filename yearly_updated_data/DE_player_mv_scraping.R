...
urlteams=c("1. FC Köln","1.FC Kaiserslautern","1.FC Nuremberg","1.FSV Mainz 05","Alemannia Aachen","Arminia Bielefeld","Bayer 04 Leverkusen","Bayern Munich","Borussia Dortmund","Borussia Mönchengladbach","Eintracht Braunschweig","Eintracht Frankfurt","FC Augsburg","FC Energie Cottbus","FC Hansa Rostock","FC Ingolstadt 04","FC Schalke 04","FC St. Pauli","Fortuna Düsseldorf","Hamburger SV","Hannover 96","Hertha BSC","Karlsruher SC","MSV Duisburg","RB Leipzig","SC Freiburg","SC Paderborn 07","SpVgg Greuther Fürth","SV Darmstadt 98","SV Werder Bremen","TSG 1899 Hoffenheim","VfB Stuttgart","VfL Bochum","VfL Wolfsburg")
