...
datac=read.csv("DE_final_dataset.csv")

# excluding non played matches
dataf=datac[-c((nrow(datac)-8):nrow(datac)),]
dataf=dataf[!is.na(dataf$IWH),]
...
calc_prof(minprofmarg=1.1,maxprofmarg=2.7,minprob=0.15,maxprob=0.99,c(1,3),wager=1,n.periods=10) 
